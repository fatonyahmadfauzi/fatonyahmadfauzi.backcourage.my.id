                        ...
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                                ...
                                <div class="footer-about">
                                    <p>Furnite Store Developer Team</p>
                                    <li><a>Fatoni Ahmad Fauzi</a></li>
                                    <li><a>Hannisa Nabila Azzahra</a></li>
                                    <li><a>Muhammad Daffa</a></li>
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2023 <a href="index.html">KELOMPOK</a>. Fatony Ahmad Fauzi, Hannisa, Daffa</a></p>
                            </div>
                        </div>
                        <div class="col-auto mb-6">
