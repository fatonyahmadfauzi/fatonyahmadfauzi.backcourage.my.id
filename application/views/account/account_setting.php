                        ...
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    ...
                                    <li class="active" aria-current="<?php echo site_url('account_user')?>">My Account</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
				...
				<div class="col-sm-12 col-md-3 col-lg-3">
					...
					<div class="dashboard_tab_button" data-aos="fade-up" data-aos-delay="0">
						<ul role="tablist" class="nav flex-column dashboard-list">
							...
							<li><a href="#passwords" data-bs-toggle="tab"
				...
				<div class="col-sm-12 col-md-9 col-lg-9">
					...
					<div class="tab-content dashboard_content" data-aos="fade-up" data-aos-delay="200">
						...
						<div class="tab-pane fade" id="passwords">
							...
							<div class="table_page table-responsive">
								<form id="password_settings" action="#" method="POST" action="<?php echo base_url('')?>">
									...
									<div class="update_submit">
										<button class="btn btn-md btn-black-default-hover mb-4" type="submit">Update</button>
										<button class="btn btn-md btn-black-default-hover mb-4" type="submit">Cancel</button>
									</div>
								</form>
							</div>
						</div>
										...
										<form action="#">
											...
											<div class="default-form-box mb-20">
												...
												<div class="img-circle mb-3">
													<?php
													$folder = 'application/views/profile/'; // Ubah "folder_bahasa" dengan nama folder yang sesuai
													$gambar = 'shiro.jpg'; // Ubah "gambar.jpg" dengan nama gambar yang sesuai

													$path = $folder . $gambar;
													?>
													<img src="<?php echo $path; ?>" alt="Gambar" class="shadow">
												</div>
											</div>
											<div class="default-form-box mb-20">
