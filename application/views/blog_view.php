        ...
        <div class="hero-slider-active swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-single-slider-item swiper-slide">
                    <?php foreach($products1->result() as $product): ?>
                    <!-- Hero Slider Image -->
                    <div class="hero-slider-bg">
                        <img src="<?php echo base_url().'/upload/'.$product->product_picture;?>" alt="Gambar Produk">
                    </div>
                    <!-- Hero Slider Content -->
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        ...
                                        <a href="<?php echo site_url('katalog_product');?>" class="btn btn-lg btn-outline-golden">shop now </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Start Hero Single Slider Item -->
                <div class="hero-single-slider-item swiper-slide">
                    <?php foreach($products2->result() as $product): ?>
                    <!-- Hero Slider Image -->
                    <div class="hero-slider-bg">
                        <img src="<?php echo base_url().'/upload/'.$product->product_picture;?>" alt="Gambar Produk">
                    </div>
