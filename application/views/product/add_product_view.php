    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">Product List - Add Product</h3>
    ...
    <div class="container">
        <div class="col-md-6 offset-md-3"> 
            <form action="<?php echo site_url('product/save');?>" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn-primary" style="height: 35px; width: 75px; border: none; margin-top: 5px;">Submit</button>
            </form>
        </div>
    </div>
